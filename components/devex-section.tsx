...
const STEPS = [
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Install the Lens SDK" },
      { type: "command", text: "npm install @lens/sdk" },
      { type: "gap" },
      { type: "comment", text: "# Initialize your project" },
      { type: "command", text: "npx lens init" },
      { type: "gap" },
  ...
  },
  {
    ...
    desc: "Start with the right perspective",
    file: "experts/coach.ts",
    lang: "typescript",
    code: [
      { type: "comment", text: "// experts/coach.ts" },
      { type: "keyword", text: "import", after: " { Expert } ", keyword2: "from", string: " '@lens/sdk'" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { VectorMemory } ", keyword2: "from", string: " '@lens/memory'" },
      { type: "gap" },
  ...
  },
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Deploy to Lens Cloud" },
      { type: "command", text: "lens deploy --prod" },
      { type: "gap" },
      ...
      { type: "url", text: "  → https://lens.dev/experts/coach" },
    ],
  },
]
